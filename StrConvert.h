...
std::string CStringToString(const CString& cstr); // CString을 std::string으로 변환하는 함수
CString StringToCString(const std::string& str); // std::string을 CString으로 변환하는 함수
CString StringTableToCString(UINT strID); // String Table을 CString으로 변환하는 함수
